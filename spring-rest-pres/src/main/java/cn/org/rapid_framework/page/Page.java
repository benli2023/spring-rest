...
public class Page<T> implements Serializable,Iterable<T>
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1293200179663965503L;
    ...
    /**
     * 得到用于多页跳转的页码
     * 由于重载了此方法，所以在JSP里调用时会出现NullPointerException,所以注释了此行
     * Due to this method is overloaded and JSP el expression do not support overloaded method (it will throw NullPointerException otherwise),so i comment this method in order to avoid overload
     * @return
     */
