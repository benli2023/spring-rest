...
public enum GeneratorConstants {
	...
	JDBC_USERNAME("jdbc_username","root","数据源:用户名"),
	JDBC_PASSWORD("jdbc_password","password","数据源:密码"),
	JDBC_DRIVER("jdbc_driver","com.mysql.jdbc.Driver","数据源:驱动"),
	JDBC_URL("jdbc_url","jdbc:mysql://localhost:3306/jtabletestdb?useUnicode=true&amp;characterEncoding=UTF-8","数据源:URL"),
