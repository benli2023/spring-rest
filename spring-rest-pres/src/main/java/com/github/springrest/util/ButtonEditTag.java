...
public class ButtonEditTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		builder.append("<input type=\"input\" class=\"mini-buttonedit-input " + cssClass + "\" autocomplete=\"off\" placeholder=\"\" name=\"" + name + "\" style=\"width: 103px;\" id=\"" + id
				+ "\" value=\"" + txtVal + "\" />");
		builder.append("<input type=\"hidden\" name=\"" + hiddenName + "\" value=\"" + hiddenVal + "\"  class=\"popup_hidden_Id\" />");
		builder.append("<span class=\"mini-buttonedit-button\" onmouseover=\"PopupSelection.addClass(this,'mini-buttonedit-button-hover');\" onmouseout=\"PopupSelection.removeClass(this,'mini-buttonedit-button-hover');\" onclick=\"PopupSelection.openSelection('"
				+ id + "','" + profileId + "')\" >");
	...
	private void evaluateExpressions() throws JspException {
		try {
			txtVal = (String) ExpressionUtil.evalNotNull("button-edit", "txtVal", _txtVal, String.class, this, pageContext);
		...
		try {
			hiddenVal = (String) ExpressionUtil.evalNotNull("button-edit", "hiddenVal", _hiddenVal, String.class, this, pageContext);
		} catch (NullAttributeException ex) {
